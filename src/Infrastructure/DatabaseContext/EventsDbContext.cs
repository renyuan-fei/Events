...
public class EventsDbContext : DbContext, IEventsDbContext
{
  ...
  /// </summary>
  /// <param name="options">
  ///   The options for configuring the <see cref="AppIdentityDbContext" />
  ///   .
  /// </param>
  ...
  /// </summary>
  /// <param name="options">
  ///   The <see cref="DbContextOptions{AppIdentityDbContext}" /> used to
  ...
  /// <summary>
  ///   Initializes a new instance of the AppIdentityDbContext class.
  /// </summary>
...
/// </summary>
public class
    ApplicationDbContextFactory : IDesignTimeDbContextFactory<EventsDbContext>
{
  /// <summary>
