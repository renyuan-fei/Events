...
public abstract class ValueObject
{
  ...
  /// <returns>Returns true if the two ValueObject instances are not equal, otherwise returns false.</returns>
  ...
  /// </summary>
  /// <returns>
  /// An <see cref="IEnumerable{T}"/> of <see cref="object"/> representing the equality components.
  /// </returns>
