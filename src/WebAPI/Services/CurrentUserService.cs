...
namespace WebAPI.Services
{
    ...
    {
        /// <summary>
        /// The _httpContextAccessor variable is an instance of the IHttpContextAccessor interface, which is used to provide access to the current HttpContext.
        /// </summary>
        /// <remarks>
        /// The IHttpContextAccessor interface is used in ASP.NET Core to encapsulate the context of an individual HTTP request.
        /// It provides access to the current HttpContext, which contains information about the current request and response,
        ...
        /// </summary>
        /// <param name="httpContextAccessor">The IHttpContextAccessor instance which provides access to the HttpContext.</param>
