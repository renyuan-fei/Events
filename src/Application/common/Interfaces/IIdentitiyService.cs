...
public interface IIdentityService
{
  ...
  ///   The task result contains the username as a string, or null if the user ID is invalid or
  ...
  ///   The task result contains a boolean value indicating if the user is in the specified
  ///   role.
  /// </returns>
  Task<bool> IsInRoleAsync(string userId, string role);

  /// <summary>
  ///   Authorizes the user with the specified user ID against the given policy name
  ///   asynchronously.
  /// </summary>
  ...
  ///   value indicating
  ///   whether the user is authorized to access the resources protected by the specified
  ///   policy.
  /// </returns>
  ...
  ///   and a string representing the user ID if the operation succeeds.
  /// </returns>
  ...
  /// <returns>
  ///   A task representing the asynchronous operation. The task will complete with a
  ///   Result object indicating the success or failure of the deletion.
  /// </returns>
