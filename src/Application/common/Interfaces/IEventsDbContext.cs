...
public interface IEventsDbContext
{
  ...
  /// </summary>
  /// <remarks>
  ///   This property is a DbSet that represents the collection of UserFollowings in the
  ///   database.
  ///   DbSet provides functionality for querying, adding, modifying and deleting entities.
  /// </remarks>
  DbSet<Follow> Following { get; }
  ...
  ///   A concurrency violation is encountered
  ///   while saving to the database. This is usually caused by a database trigger that
  ///   indicates another user has changed a record in the database.
  /// </exception>
  /// <exception cref="InvalidOperationException">
  ///   Some error occurred attempting to process
  ///   entities in the context either before or after sending commands to the database.
  /// </exception>
  /// <exception cref="NotSupportedException">
  ///   An attempt was made to use unsupported behavior
  ...
  ///   If the <paramref name="cancellationToken" /> is
  ///   cancelled.
  /// </exception>
