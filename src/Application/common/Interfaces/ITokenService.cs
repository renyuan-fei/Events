...
public interface IJwtTokenService
{
  ...
  /// <param name="isRefresh">A boolean flag indicating whether the token is being refreshed. (Optional, default value is false)</param>
  ...
  /// <returns>
  /// A <see cref="ClaimsPrincipal"/> object if the token is valid and contains valid claims,
