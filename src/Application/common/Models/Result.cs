...
public class Result
{
  ...
  /// </summary>
  /// <remarks>
  /// This property is used to store and access a collection of errors. It is a string array that can be initialized during object construction using the 'init' keyword.
